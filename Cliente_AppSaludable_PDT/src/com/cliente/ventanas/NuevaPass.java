...
public class NuevaPass implements ActionListener{
	...
	private void initialize(int id) {
		...
		Usuario user=ControladorUsuarios.ObtenerUsuario((long) id);
		...
		String genero = "";
		if(user.getGenero().equals(1)) {genero="MASCULINO";}
		if(user.getGenero().equals(2)) {genero="FEMENINO";}
	...
	protected void NuevaPassword(String pass,Long identifica) {
