...
public class ModificarPass implements ActionListener {
	...
	private void initialize() {
		...
		JLabel lblIngresarNuevaContrasea = new JLabel("Cambio de contrase\u00F1a");
		lblIngresarNuevaContrasea.setForeground(Color.BLUE);
		lblIngresarNuevaContrasea.setBackground(Color.BLACK);
		lblIngresarNuevaContrasea.setBounds(98, 11, 194, 14);
		frame.getContentPane().add(lblIngresarNuevaContrasea);
		
		JLabel lblBuscarUsuario = new JLabel("Buscar Usuario:");
		lblBuscarUsuario.setBounds(10, 48, 134, 14);
		frame.getContentPane().add(lblBuscarUsuario);
		...
		btnCambiarContrasea.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				cambiarPass(idUsuario);
			}
		});
		btnCambiarContrasea.setBounds(47, 223, 178, 23);
